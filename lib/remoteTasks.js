...
(function() {
  ...
  module.exports = {
    ...
    startApp: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "cd " + (getAppLocation(pm2mConf)) + " && sudo pm2 start " + _settings.pm2EnvConfigName);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    stopApp: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "cd " + (getAppLocation(pm2mConf)) + " && sudo pm2 stop " + _settings.pm2EnvConfigName);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    status: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "sudo pm2 show " + pm2mConf.appName);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    killApp: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "sudo pm2 delete " + pm2mConf.appName);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    softReloadApp: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "cd " + (getAppLocation(pm2mConf)) + " && sudo pm2 startOrReload " + _settings.pm2EnvConfigName);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    hardReloadApp: function(session, pm2mConf, done) {
      var cmd1;
      cmd1 = cmdString(pm2mConf, "cd " + (getAppLocation(pm2mConf)) + " && sudo pm2 delete " + pm2mConf.appName);
      return session.execute(cmd1, {}, function(err, code, logs) {
        ...
        if (err) {
          ...
          cmd2 = cmdString(pm2mConf, "cd " + (getAppLocation(pm2mConf)) + " && sudo pm2 start " + _settings.pm2EnvConfigName);
    ...
    scaleApp: function(session, pm2mConf, sParam, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "sudo pm2 scale " + pm2mConf.appName + " " + sParam);
      return session.execute(cmd, {}, function(err, code, logs) {
        if (err) {
          return done(err);
        } else {
    ...
    getAppLogs: function(session, pm2mConf, done) {
      var cmd;
      cmd = cmdString(pm2mConf, "sudo pm2 logs " + pm2mConf.appName);
